...
export const realEstateObjects: RealEstateObject[] = [
  {
    ...
    price: 765000,
    floor: 'Garten / EG',
    features: ['Gartenanteil', '2 Badezimmer', 'Tiefgarage (optional)'],
    status: 'available',
  ...
  },
  {
    ...
    price: 949000,
    floor: 'Garten / EG',
    features: ['Große Wohnküche', '2 Badezimmer', 'Tiefgarage (optional)'],
    status: 'available',
  ...
  },
  {
    ...
    size: 93.36,
    price: 650000,
    features: ['Balkon', '2 Badezimmer', 'Tiefgarage (optional)'],
    status: 'available',
  ...
  },
  {
    ...
    size: 122.24,
    price: 849000,
    features: ['Großer Wohnbereich', '2 Badezimmer', 'Tiefgarage (optional)'],
    status: 'available',
  ...
  },
  {
    ...
    size: 133.82,
    price: 1049000,
    features: ['Süd-/West-Ausrichtung', '2 Badezimmer', 'Tiefgarage (optional)'],
    status: 'available',
  ...
  },
  {
    ...
    size: 183.14,
    price: 1249000,
    features: ['Große Dachterrasse', '3 Schlafzimmer', 'Tiefgarage (optional)'],
    status: 'available',
